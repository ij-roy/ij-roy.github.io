...
$imageUrl = "https://ij-roy.github.io/postofficesaathi/preview.jpg"
...
Assert-Contains -Content $html -Expected ('<meta http-equiv="refresh" content="0;url=' + $playStoreUrl + '">') -Message "Missing meta refresh redirect"
